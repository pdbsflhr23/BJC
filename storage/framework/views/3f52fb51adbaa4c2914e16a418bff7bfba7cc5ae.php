                    ...
                    <li class="item-feed dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-messages">
                            <li>
                                <a class="dropdown-menu-messages-item" href="">
                                    <div class="dropdown-menu-messages-item-image">
                                        <img src="<?php echo e(asset_segmented('img/james-taylor.jpg')); ?>" alt="James T">
                                    </div>
                            ...
                            <li>
                                <a class="dropdown-menu-messages-item" href="">
                                    <div class="dropdown-menu-messages-item-image">
                                        <img src="<?php echo e(asset_segmented('img/user-1-profile.jpg')); ?>" alt="Tyrone G">
                                    </div>
                                    <div class="dropdown-menu-messages-item-ago">3hr ago</div>
                                    <div class="dropdown-menu-messages-item-content">
                            ...
                            <li>
                                <a class="dropdown-menu-messages-item" href="">
                                    <div class="dropdown-menu-messages-item-image">
                                        <img src="<?php echo e(asset_segmented('img/user-3-profile.jpg')); ?>" alt="James T">
                                    </div>
                                    <div class="dropdown-menu-messages-item-ago">3hr ago</div>
                                    <div class="dropdown-menu-messages-item-content">
                            ...
                            <li>
                                <a class="dropdown-menu-link-lg" href="<?php echo e(route('admin.appPages.inbox')); ?>">
