...
<div class="container-fluid">
    <!-- START CONTAINER -->
    <div class="row">
        <form  method="POST" action="<?php echo e(url('job/save')); ?>">
                         ...
                         <div class="form-group">
                        	...
                        	<select class="form-control input-sm" name="sales_person">
                                ...
                                <?php $__currentLoopData = $natures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								    <option value="<?php echo e($nature->nature); ?>"><?php echo e($nature->name); ?></option>
                       ...
                       <div class="row">
                           ...
                           <tbody>
                                   ...
                                   <td>
                                       <select class="form-control input-vsm drops" name="item_code[]" id="item_code_1">
                                           ...
                                           <?php $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               <option value="<?php echo e($code->id); ?>"><?php echo e($code->item_code); ?></option>
                                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                       </select>
                                   </td>
                               ...
                               <tr id="tb_2">
                                   ...
                                   <td><input type="text" name="item_price[]" id="item_price" class="form-control input-vsm"></td>
                                   <td><input type="text" name="taxable[]" id="taxable" class="form-control input-vsm"></td>
                                   <td><input type="text" name="qty[]" id="qty" class="form-control input-vsm"></td>
                                   <td><input type="text" name="nat_price[]" id="nat_price" class="form-control input-vsm"></td>
                                   <td><input type="text" name="sale_price[]" id="sale_price" class="form-control input-vsm"></td>
                                   <td><input type="text" name="discount[]" id="discount" class="form-control input-vsm"></td>
                                   <td><input type="text" name="tax_amount[]" id="tax_amount" class="form-control input-vsm"></td>
                                   <td><input type="text" name="reoccurrence[]" id="reoccurrence" class="form-control input-vsm"></td>
                                   <td><input type="text" name="rperiod[]" id="rperiod" class="form-control input-vsm"></td>
                                   <td><input type="text" name="next_reoccurrence[]" id="next_reoccurrence" class="form-control input-vsm"></td>
                               </tr>
                               <tr id="tb_3">
                                   <td><input type="text" name="item_code[]" id="item_code" class="input-vsm form-control"></td>
                                   <td><input type="text" name="item_price[]" id="item_price" class="form-control input-vsm"></td>
                                   <td><input type="text" name="taxable[]" id="taxable" class="form-control input-vsm"></td>
                                   <td><input type="text" name="qty[]" id="qty" class="form-control input-vsm"></td>
                                   <td><input type="text" name="nat_price[]" id="nat_price" class="form-control input-vsm"></td>
    ...
    <script>
        function getPrice(id) {
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(url('job/json/item/price')); ?>/"+id,
