<header class="top-header">
    <a href="{{ route('admin.dashboard') }}" class="top-header-logo">
                ...
                <ul class="nav navbar-nav navbar-right" data-dropdown-in="flipInX" data-dropdown-out="zoomOut">
                    ...
                    <li class="item-feed dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-messages">
                            <li>
                                <a class="dropdown-menu-messages-item" href="">
                                    <div class="dropdown-menu-messages-item-image">
                                        <img src="{{ asset_segmented('img/james-taylor.jpg') }}" alt="James T">
                                    </div>
                            ...
                            <li>
                                <a class="dropdown-menu-messages-item" href="">
                                    <div class="dropdown-menu-messages-item-image">
                                        <img src="{{ asset_segmented('img/user-1-profile.jpg') }}" alt="Tyrone G">
                                    </div>
                                    <div class="dropdown-menu-messages-item-ago">3hr ago</div>
                                    <div class="dropdown-menu-messages-item-content">
                            ...
                            <li>
                                <a class="dropdown-menu-messages-item" href="">
                                    <div class="dropdown-menu-messages-item-image">
                                        <img src="{{ asset_segmented('img/user-3-profile.jpg') }}" alt="James T">
                                    </div>
                                    <div class="dropdown-menu-messages-item-ago">3hr ago</div>
                                    <div class="dropdown-menu-messages-item-content">
                            ...
                            <li>
                                <a class="dropdown-menu-link-lg" href="{{ route('admin.appPages.inbox') }}">
                    ...
                    <li>
                        ...
                        <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                            <span class="fa fa-sign-out"></span> <span class="hidden-sm hidden-xs">Log out</span>
                        </a>
                    </li>
                  </ul>
        </div>
